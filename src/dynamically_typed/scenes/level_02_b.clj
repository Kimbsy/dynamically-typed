...
(defn update-level
  ...
  (-> state
      ...
      ((common/check-victory-fn :level-03))))
...
(defn draw-level
  ...
  ;; hide platform seams
  (shape/fill-rect! [602 738] [1000 100] p/grey)
  (shape/fill-rect! [802 638] [1000 100] p/grey)
  (shape/fill-rect! [1002 538] [1000 100] p/grey))
